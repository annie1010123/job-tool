...
const styles = `
  ...
  .modal{background:#fff;border-radius:18px;width:100%;max-width:880px;margin:auto;max-height:calc(100vh - 56px);display:flex;flex-direction:column;box-shadow:0 24px 64px rgba(0,0,0,.2);overflow:hidden}
  .m-head{padding:20px 24px 16px;border-bottom:1px solid #efece5;position:relative;flex-shrink:0}
  .m-eyebrow{font-size:11.5px;color:#aaa8a0;font-weight:600;letter-spacing:.03em}
  .m-title{font-size:18px;font-weight:700;line-height:1.4}
  .m-titlerow{display:flex;align-items:center;gap:12px;margin-top:5px;padding-right:30px}
  .m-close{position:absolute;top:18px;right:20px;cursor:pointer;border:none;background:none;padding:4px}
  .m-close svg{width:18px;height:18px;stroke:#888780;fill:none;stroke-width:2}

  .m-cols{display:flex;flex:1;min-height:380px;overflow:hidden}
  .col-left{flex:1;padding:20px 22px;border-right:1px solid #efece5;display:flex;flex-direction:column;overflow-y:auto}
  .col-right{flex:1;padding:20px 22px;display:flex;flex-direction:column;overflow-y:auto}

  .vbar{display:flex;align-items:center;gap:10px;margin-bottom:14px}
  .vadd{font-size:12px;color:#555552;cursor:pointer;display:flex;align-items:center;gap:3px}
  .lab{font-size:12px;font-weight:600;color:#1a1a18;margin-bottom:7px}
  .lab .note{font-weight:400;color:#9a6a1c;font-size:11.5px;margin-left:8px}
  ...
  .mini-tip{display:flex;gap:7px;align-items:flex-start;font-size:11.5px;color:#888780;line-height:1.5;margin-top:10px}
  .mini-tip svg{width:13px;height:13px;stroke:#aaa8a0;fill:none;stroke-width:1.7;flex-shrink:0;margin-top:1px}
  .left-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:14px}

  .col-right .rt{font-size:12px;font-weight:700;color:#aaa8a0;letter-spacing:.03em;margin-bottom:14px}
  .empty{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;color:#aaa8a0;gap:10px;padding:20px}
  .empty svg{width:30px;height:30px;stroke:#aaa8a0;fill:none;stroke-width:1.5}
  .empty p{font-size:12.5px;line-height:1.6;max-width:200px}

  .grade-line{display:flex;align-items:center;gap:10px;margin-bottom:16px;flex-wrap:wrap}
  .grade{font-size:14px;font-weight:700}
  .grade.ok{color:#9a6a1c}.grade.good{color:#0f6e56}.grade.bad{color:#a32d2d}
  .grade-line .gsub{font-size:12px;color:#888780}
  .fb-group{margin-bottom:15px}
  .fb-group .gt{font-size:12px;font-weight:700;color:#555552;margin-bottom:8px}
  .fb-li{display:flex;gap:9px;font-size:13px;color:#555552;line-height:1.6;margin-bottom:7px}
  .fb-li svg{width:15px;height:15px;flex-shrink:0;margin-top:2px;fill:none;stroke-width:1.9}
  .fb-li .ic-good{stroke:#0f6e56}.fb-li .ic-imp{stroke:#9a6a1c}
  .fb-li b{color:#1a1a18}
  .fb-eg{font-size:12px;color:#555552;background:#f4f1ea;border-left:2px solid #d8d1c0;border-radius:0 7px 7px 0;padding:7px 11px;margin:5px 0 11px 24px;line-height:1.65}
  .fb-eg b{color:#888780;font-weight:700;font-size:10.5px;letter-spacing:.04em;margin-right:6px}
  .chips{display:flex;gap:6px;flex-wrap:wrap}
  .chip{font-size:11.5px;padding:4px 10px;border-radius:7px;font-weight:600}
  .chip.y{background:#e6f1ea;color:#0f6e56}.chip.n{background:#f6ebea;color:#a32d2d}

  .link-act{font-size:12px;color:#555552;cursor:pointer}
  .link-act:hover{color:#1a1a18}
  .link-act.danger{color:#a32d2d}

  @media (max-width:720px){ .m-cols{flex-direction:column} .col-left{border-right:none;border-bottom:1px solid #efece5} }
`;
